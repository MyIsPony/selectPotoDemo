...
import com.yunjiankang.selectpotodemo.adapter.PhptpAdapter2;
 ...
 * 版本号:V 1.0.0
 */
public class SelectPotoActivity2 extends BaseActivity {
    ...
    private PhptpAdapter2 photoAdapter;//图片的九宫格布局数据
    ...
    public int getViewId() {
        return R.layout.activity_select_poto2;
    }
    ...
    public void initData() {
        ...
        photoAdapter = new PhptpAdapter2(this, showMorePhoto, (GridLayoutManager) rvItem0.getLayoutManager());
        rvItem0.setAdapter(photoAdapter);


        photoAdapter.setAddDrugreCordAdapterListener(new PhptpAdapter2.AddDrugreCordAdapterListener() {
            @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_close:
                showOnePhoto.clear();
                Glide.with(SelectPotoActivity2.this)
            ...
            case R.id.iv_item1://选择视频
                openImage(101);
                break;
            case R.id.tv_item0://删除压缩后的文件
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        LubanUtils.getInstance().deleteFile(SelectPotoActivity2.this);
                    }
                }).start();
    ...
    private void showPupop(ArrayList<Photo> selectedPhotoList, int tion) {
        ...
        xbannerItem0.loadImage(new XBanner.XBannerAdapter() {
            ...
            public void loadBanner(XBanner banner, Object model, View view, int position) {
                Glide.with(SelectPotoActivity2.this).load(selectedPhotoList.get(position).uri).into((ImageView) view);//设置图片为默认图片
            }
        });
